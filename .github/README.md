...
### ✅ Electron [v39.0.0](https://releases.electronjs.org/release/v39.0.0) → [v39.8.7](https://releases.electronjs.org/release/v39.8.7)

**Patch Version:** v39.0.0  
**Tested Range:** v39.0.0 – v39.8.7
...
- **Electron v39.0.0 - v39.8.7** - [README & Patches](https://github.com/RockinChaos/electron-codec-patches/tree/master/v39.0.0)
